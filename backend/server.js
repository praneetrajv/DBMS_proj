...
app.get("/api/friendship/outgoing-requests", async (req, res) => {
...
// Update user profile settings (including profile type)
...
app.get("/api/user/:userId/can-view", async (req, res) => {
  ...
  try {
    ...
    // For private profiles, check if they are friends
